...
**Изучаемые команды:** повторение всех изученных команд

## Дополнительные задания для продвинутых учеников

### Задание A: Статистический анализ
```bash
# Найти все числовые значения в записях
